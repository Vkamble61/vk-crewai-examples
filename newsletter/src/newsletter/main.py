...
def load_html_template():
    ...
    """
    with open('src/newsletter/templates/newsletter_template.html', 'r', encoding='utf-8') as file:
        return file.read()
...
def run():
    ...
    inputs = {
        ...
        'personal_message': input("Enter a personal message to include in the newsletter: "),
...
def run_with_trigger():
    ...
    try:
        result = Newsletter().crew().kickoff(inputs=inputs)
        return result
    except Exception as e:
