...
class CampaignIdeas(BaseModel):
	...
	campaigns: List[CampaignIdea] = Field(..., description="List of campaign ideas")
...
class MarketingPostsCrew():
	...
	def marketing_strategy_task(self) -> Task:
		return Task(
			...
			agent=self.chief_marketing_strategist(),
			output_file='output/marketing_strategy.md',
	...
	def campaign_idea_task(self) -> Task:
		return Task(
			...
			output_file='output/campaign_ideas.md',
	...
	def copy_creation_task(self) -> Task:
		return Task(
			...
			output_file='output/copies.md',
			#output_json=List[Copy]
		)
